          ...
          {!isAuthReady ? (
            ...
            <>
              <form onSubmit={handleEmailSubmit} className="space-y-4 mb-6">
                {authMode === 'signup' && (
                  <input
                    ...
                    required
                    className="w-full bg-slate-800/50 border border-slate-700 rounded-xl px-4 py-3 text-white placeholder:text-gray-500 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all"
                  />
                )}
                <input
                  type="email"
                ...
                <motion.button
                  ...
                  className="w-full py-3.5 bg-cyan-600 hover:bg-cyan-500 text-white rounded-xl font-bold shadow-xl transition-all flex items-center justify-center gap-3 text-base relative overflow-hidden group"
                >
                  {loadingId === 'email' ? (
              ...
              <motion.button
                ...
                disabled={loadingId !== null}
                className="w-full py-3.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white rounded-xl font-bold shadow-xl transition-all flex items-center justify-center gap-3 text-base relative overflow-hidden group"
              >
                {loadingId === 'google' ? (
                   <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-white"></div>
                ) : (
